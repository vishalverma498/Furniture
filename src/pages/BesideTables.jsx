...
const chairImages = [
  "/images/BedsideTables/0012.jpg",
  "/images/BedsideTables/001.jpg",
  "/images/BedsideTables/002.jpg",
  "/images/BedsideTables/003.jpg",
  "/images/BedsideTables/004.jpg",
  "/images/BedsideTables/005.jpg",
  "/images/BedsideTables/006.jpg",
  "/images/BedsideTables/007.jpg",
  "/images/BedsideTables/008.jpg",
  "/images/BedsideTables/009.jpg",
  "/images/BedsideTables/0010.jpg",
  "/images/BedsideTables/0011.jpg",
];
...
export default function BesideTables() {
    ...
    <div className="min-h-screen w-screen bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-10 pb-10">
        <div className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-12">
          {/* Thumbnails */}
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 sm:gap-6 max-h-[80vh] overflow-y-auto pr-0.5 lg:min-w-[400px] lg:max-w-[500px">
